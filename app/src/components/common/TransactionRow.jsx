  ...
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-3xl border border-white/70 bg-card shadow-soft transition-all hover:shadow-soft-lg sm:flex-row">
      ...
      {transaction.queue_number ? (
        <div className="flex shrink-0 flex-row items-center justify-center gap-2 border-b border-dashed border-black/10 bg-base p-4 sm:w-24 sm:flex-col sm:border-b-0 sm:border-r">
        ...
        <div className="hidden shrink-0 items-center justify-center border-r border-black/5 sm:flex sm:w-24">
          ...
          <div className="mt-2 flex gap-2 sm:mt-3">
            {showStatusButton && onToggleStatus && (
              <button
                ...
                className="rounded-full bg-base px-3 py-1.5 text-xs font-medium text-slate-600 shadow-soft-sm transition active:shadow-soft-in-sm"
              >
                Status
              </button>
            )}
