...
function TestimonialCard({ testimonial, index }) {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="rounded-4xl border border-white/70 bg-card p-6 text-left shadow-soft transition-all duration-300 hover:shadow-soft-lg"
    >
      ...
      <p className="leading-relaxed text-slate-600">"{testimonial.text}"</p>
